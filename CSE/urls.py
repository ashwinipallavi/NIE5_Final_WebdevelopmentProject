...
urlpatterns = [
    ...
    path('forms2', EmployeeForms.as_view(), name='forms'),
    path('<pk>/detail2', EmployeeDetail.as_view(), name='detail'),
    path('<pk>/update2', EmployeeUpdate.as_view(), name='update'),
    path('<pk>/delete2', EmployeeDelete.as_view(), name='delete'),
